  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context
          ...
          .add(OnWatchlistMovieStatusCalled(widget.id));
    });
  }

  @override
  Widget build(BuildContext context) {
    final isAddedToWatchlist = context.select<WatchlistMoviesBloc, bool>(
      (bloc) {
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  context
                                      .read<WatchlistMoviesBloc>()
                                      .add(OnAddMovieToWatchlistCalled(widget.movie));
                                }
                                else {
                                  context
                                      .read<WatchlistMoviesBloc>()
                                      .add(OnRemoveMovieWatchlistCalled(widget.movie));
                                }
